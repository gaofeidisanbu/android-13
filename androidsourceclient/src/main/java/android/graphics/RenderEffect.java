...
public final class RenderEffect {
     ...
     * then all drawing commands issued with a {@link RenderNode} that this
     ...
     * {@link RenderNode} that this RenderEffect is installed on with the
     ...
     * {@link RenderNode} that this RenderEffect is installed on
     * @param colorFilter ColorFilter applied to the content in the input RenderEffect
     */
    @NonNull
     ...
     * the contents of the {@link RenderNode} that this RenderEffect is installed
